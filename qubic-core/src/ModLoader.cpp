...
extern "C" DLL_EXPORT JNIEXPORT void JNICALL Java_QubicNative_Init(JNIEnv* env, jclass clazz) {
...
extern "C" DLL_EXPORT JNIEXPORT void JNICALL Java_QubicNative_RegisterModItems(JNIEnv* env, jclass clazz) {
    printf("[Qubic] ========================================\n");
